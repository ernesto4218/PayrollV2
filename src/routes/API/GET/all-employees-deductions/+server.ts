...
import { getAllEmployees, getAllEmployeesDeductions, getAllEmployeesUndertime } from '$lib/server/db/repositories/employee.repo';
...
export const GET: RequestHandler = async ({ url }) => {
    try {
        ...
        const data = await getAllEmployeesDeductions(month, year);
        return json(data);
    } catch (e) {
        console.error(e);
